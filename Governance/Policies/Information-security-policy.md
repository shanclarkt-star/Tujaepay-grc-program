...
The purpose of this Information Security Policy is to establish requirements for protecting TujaePay’s information assets from unauthorized access, disclosure, alteration, and destruction. This policy supports the confidentiality, integrity, and availability of company data.

**2. Scope**

This policy applies to all TujaePay employees, contractors, vendors, and third parties who access TujaePay systems, networks, or data.
...
Violations of this policy may result in disciplinary action, up to and including termination, and possible legal consequences.

**8. Review**

This policy is reviewed annually or upon significant changes to the business or threat environment.
